import { BrainCog, Map, Stethoscope } from "lucide-react";
...
function AdminInstansiDashboard() {
    ...
    if (isGetting || isGettingDataset) return <div className="flex items-center justify-center h-screen"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div></div>;
